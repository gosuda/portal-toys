...
func init() {
	...
	flags.StringVar(&flagOwner, "owner", "Free Chat", "lease owner")
	flags.StringVar(&flagTags, "tags", "chat,free", "comma-separated lease tags")
...
func runChat(cmd *cobra.Command, args []string) error {
	...
	// Build single client and listener (use all bootstrap servers)
